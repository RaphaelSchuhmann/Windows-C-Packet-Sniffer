...
## Note
If you want to execute either of those two programs, you'll need both the [npcap sdk](https://npcap.com/dist/npcap-sdk-1.15.zip) (Follow the [compile.md](https://github.com/RaphaelSchuhmann/Windows-C-Packet-Sniffer/blob/main/compile.md)) and the [npcap runtime](https://npcap.com/dist/npcap-1.83.exe).
